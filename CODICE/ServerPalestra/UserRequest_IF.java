...
public interface UserRequest_IF {
	...
	/**
	 * Ritorna la lista di esercizi della scheda fitness aggiornata in base allo
	 * stato corrente dei macchinari
	 *
	 * @param ID dell'utente
	 * @return lista di esercizi della scheda in formato JSON (con associato l'id
	 *         della richiesta)
	 */
