...
public class ControllerAutenticazione implements ControllerAutenticatoreIF {
	...
	/*
	 * ricevendo la richiesta di autenticazione dall'App dovrebbe passare i dati al
	 * server LDAP, verificare l'autenticazione e comunicare l'esito all'utente
	 */
	...
	public String logout(String nome, String password) {
